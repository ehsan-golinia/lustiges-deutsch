...
class GameRoomConsumer(WebsocketConsumer):
    ...
    def receive(self, text_data):
        ...
        event = None
        if text_data_json['action'] == 'roll_dice':
            ...
            event = {
                'type': 'roll_dice_state',
                'board_state': self.game_room.board_state,
                'active_turn': self.game_room.active_turn.username,
                'quiz': {
                    'english': rand_q.english,
                    'turkish': rand_q.turkish,
                    'german': rand_q.german
                },
                'players': [
                        {
                            'id': pl.player.id,
...
class YourConsumer(AsyncWebsocketConsumer):
    ...
    async def broadcast_message(self, event):
        ...
        # The event parameter contains the message payload
